...
class JavaCommands {
  static const List<BedrockCommand> all = [
    ...
    BedrockCommand(
      ...
      'Ban an IP address',
      'Players',
      args: [CommandArg('address', ArgType.text)],
    ),
    BedrockCommand(
      'pardon-ip',
    ...
    BedrockCommand(
      ...
      'Players',
      args: [CommandArg('target', ArgType.player, required: false)],
    ),
    BedrockCommand(
      'give',
    ...
    BedrockCommand(
      ...
      'Server',
      args: [CommandArg('command', ArgType.text, required: false)],
    ),
  ];
