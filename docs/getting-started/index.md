...
2. A Minecraft Bedrock or Java server running the companion **Admincraft WebSocket** service.

The WebSocket bridges Admincraft to the Bedrock Docker console or Java RCON. Because that bridge can execute commands, the connection must be protected by a private encrypted network or TLS.
...
| A Java Docker server, or nothing yet | Follow the [Java Edition setup](java-server.md) |
